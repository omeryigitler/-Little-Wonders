...
export default function AccountLoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-boutique-bg px-6 py-10 font-sans text-boutique-brown">
      ...
      <div className="relative z-10 w-full max-w-md overflow-hidden rounded-[2rem] border border-boutique-brown/10 bg-white/86 p-7 shadow-[0_24px_70px_rgba(58,37,26,0.12)] backdrop-blur-sm">
