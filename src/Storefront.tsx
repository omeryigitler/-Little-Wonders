      ...
      <main className="flex-1 relative z-10 flex flex-col items-center justify-start pt-10 md:pt-4 pb-8 md:pb-0 overflow-visible">
        ...
        <div className="text-center max-w-4xl px-6 mb-6 md:mb-3 relative z-10 mt-2">
          <h1 className="font-serif text-[42px] leading-[1.15] md:text-[64px] text-boutique-brown mb-5 md:mb-4">
            <span className="relative inline-block">
              ...
              <span className="absolute -right-10 -top-2 scale-75 md:scale-100"><SparkleIcon /></span>
            </span>
            <br/>
            Made with Love
          </h1>
          <p className="font-sans text-lg md:text-[20px] text-boutique-brown-light max-w-3xl mx-auto leading-relaxed">
            Welcome to our magical nursery boutique. Discover bespoke heirlooms, exquisitely soft blankets, and heartfelt gifts customized just for them.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-y-14 px-4 md:px-8 w-full max-w-[1620px] mx-auto z-20 relative md:-mb-6 md:-mt-4">
          {productRows.map((row, rowIndex) => (
            <div
              key={rowIndex}
              className="flex flex-col md:flex-row justify-center items-center md:items-stretch gap-6 md:gap-4 w-full"
            >
              {row.map((product) => (
                <div key={product.id} className="flex w-full max-w-[520px] md:w-[32.5%]">
        ...
        <div className="max-w-[1300px] mx-auto px-6 grid grid-cols-1 md:grid-cols-4 md:divide-x divide-y md:divide-y-0 divide-boutique-brown/15 relative z-10">
          ...
          <div className="flex flex-col gap-3 py-4 md:py-0 md:px-10">
            <h4 className="font-serif tracking-[0.1em] text-boutique-brown text-sm md:text-[14px] uppercase flex items-center gap-3 mb-1">
              SHOP 
              <div className="flex items-end gap-2 translate-y-[-2px]">
                <img src="/toy-abc-blocks.png" className="w-[42px] h-auto object-contain mix-blend-multiply opacity-90 drop-shadow-sm" alt="" />
                <img src="/toy-wooden-train.png" className="w-[63px] h-auto object-contain mix-blend-multiply opacity-90 drop-shadow-sm" alt="" />
              </div>
            </h4>
          ...
          <div className="flex flex-col gap-3 py-4 md:py-0 md:pl-10 relative">
            <h4 className="font-serif tracking-[0.1em] text-boutique-brown text-sm md:text-[14px] uppercase flex items-center gap-3 mb-1">
              STAY CONNECTED 
              <img src="/toy-teddy-ring-teether.png" className="w-[51px] h-auto object-contain mix-blend-multiply translate-y-[-2px] drop-shadow-sm" alt="" />
            </h4>
...
function SparkleIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 0L13.8 8.2L22 10L13.8 11.8L12 20L10.2 11.8L2 10L10.2 8.2L12 0Z" fill="#d9b691"/>
      <path d="M5 16L5.6 18.4L8 19L5.6 19.6L5 22L4.4 19.6L2 19L4.4 18.4L5 16Z" fill="#d9b691"/>
    </svg>
  );
}
