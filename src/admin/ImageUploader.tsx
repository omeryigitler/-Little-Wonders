  ...
  return (
    <div className="space-y-4">
        ...
        >
          ...
          {isUploading ? (
            ...
            <>
               ...
               <span className="text-xs text-gray-500 font-medium text-center px-4">Upload to Cloudinary</span>
            </>
          )}
        </label>
      </div>
      ...
      <p className="text-xs text-gray-400">
        Images are uploaded to Cloudinary and product data is saved in PostgreSQL through Prisma.
      </p>
    </div>
  );
};
