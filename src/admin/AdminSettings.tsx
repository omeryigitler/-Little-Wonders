  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <SettingCard icon={Truck} title="Shipping" status="Basic">Flat shipping is currently used in checkout. Next step: add shipping rules by location, order value, or product type.</SettingCard>
